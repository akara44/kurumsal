                    ...
                    <div class="row align-items-center justify-content-center justify-content-lg-between">
                        ...
                        <div class="col-xl-5 col-lg-6">
                            <div class="banner__content">
                                <h2 class="title wow fadeInUp" data-wow-delay=".2s"><span>{{ $homebanner->baslik }}</h2>
                                <p class="wow fadeInUp" data-wow-delay=".4s">{{ $homebanner->alt_baslik }}</p>
                                <a href="about.html" class="btn banner__btn wow fadeInUp" data-wow-delay=".6s">Daha Fazla...</a>
                            </div>
                        </div>
                    </div>
                </div>
