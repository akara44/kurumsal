                        ...
                        <form method="post" action="{{ route('blog.icerik.guncelle.form') }}" enctype="multipart/form-data" id="myForm">
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-8">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-sm-12 form-group">
                                                ...
                                                <textarea name="metin" id="elm1" type="text">{{ $icerikler->metin }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-sm-12">
                                                <select class="form-select" aria-label="Default select example" name="kategori_id">
                                                    ...
                                                    @foreach($kategoriler as $kategori)
                                                        <option value="{{ $kategori->id }}" {{ $kategori->id == $icerikler->kategori_id ? 'selected' : '' }}>{{ $kategori->kategori_adi }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <input type="submit" class="btn btn-info waves-effect waves-light" value="İçerik Güncelle">
                                </div>
                            </div>
                        </form>
                    </div>
